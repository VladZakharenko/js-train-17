...
function checkRegexFlags(regex) {
  ...
  let result = flags.includes('g') && flags.includes('m')
...
function replaceWordOccurrences(str, word, newWord) {
  ...
  const result = str.replaceAll(re, newWord)
  return result 
